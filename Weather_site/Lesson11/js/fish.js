...
const fetchCurrentWeatherData = async () => {
  ...
  const fetchFiveDayWeatherData = async () => {
    const response = await fetch("https://api.openweathermap.org/data/2.5/forecast?id=4155430&appid=ff64551a0d603239a02c046858ddfe50&units=imperial")
  ...
  function makeHTML() {
    try {
      ...
      .then((response) => response.json())
        .then((data) => {
            let fish_heaven_events = data.towns[2].events
